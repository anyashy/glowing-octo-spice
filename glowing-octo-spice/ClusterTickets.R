...
ticket_contents_clean <- gsub("please describe below the problem you are having so we can improve your experience","", ticket_contents_clean)
ticket_contents_clean <- gsub("please describe your problem so that we can improve your experience","", ticket_contents_clean)
ticket_contents_clean <- gsub("please describe your problem so that we can improve your experience","", ticket_contents_clean)
ticket_contents_clean <- gsub("please describe below the problem you are having so we can improve your experience","", ticket_contents_clean)
